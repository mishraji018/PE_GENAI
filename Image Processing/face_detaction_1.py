...
while True:
    ...
    if results.multi_face_landmarks: #agar face landmarks detect hote hain to unhe draw karna hai.
        for face_landmarks in results.multi_face_landmarks:
            ...
            points=face_landmarks.landmark[33] #face landmarks ke points nikalna hai. total 468 points hote hain, yaha 33rd point nikalna hai.
            #pixel coordinate m convert kr rhe h.
            x=int(points.x*w) #x coordinate nikalna hai.
            y=int(points.y*h) #y coordinate nikalna hai.
            cv2.circle(frame,(x,y),5,(0,255,0), 1) #frame par circle draw karna hai.
